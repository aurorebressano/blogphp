...
type ENUM('Admin', 'Moderateur') NOT NULL,
...
insert into account(type, nom, prenom, email, mot_de_passe) values('Admin', 'Bressano', 'Aurore', 'aurorebressano@gmail.com', 'motDePasseBlog');

select * from account;
describe comment;

#------------------------- INSERTION POSTS
insert into blogpost(titre, date, auteur, chapo, contenu, imgheader, imgsecondary) values("Bordeaux : Le public peut découvrir le bébé jaguar né au zoo de Pessac", DATE(NOW()), "M.B.", " EVENEMENT - Une naissance de jaguar en captivité reste « rare et exceptionnelle » assure le zoo de Pessac en Gironde ", "C’est un événement, que les équipes du zoo de Pessac, près de Bordeaux (Gironde), peuvent désormais partager avec le public. Le bébé jaguar né dans l’enceinte du zoo le 28 août dernier, peut désormais être admiré par les visiteurs, annonce l’établissement. « Sa première sortie a eu lieu le week-end dernier et s’est très bien déroulée » explique le zoo, qui attendait ces premiers pas avec impatience. L’animal, qui pesait 4,9 kg après cinq semaines est né du rapprochement au sein du zoo de Catalina et Mato, ses deux parents, il y a cinq ans. Espèce menacée
...
insert into blogpost(titre, date, auteur, chapo, contenu, imgheader, imgsecondary) values("Les services de sécurité et de secours bientôt équipés d’un réseau de communication très haut débit", DATE(NOW()), "20 Minutes avec agence ", "Equipements - Ce « Réseau Radio du Futur » permettra aux agents des services de secours et de sécurité de communiquer de manière plus efficace à partir de 2024 ", "Le gouvernement a annoncé le renouvellement des équipements de communication des services de secours et de sécurité, comme l’avait annoncé Emmanuel Macron dès 2017. Ce jeudi, le ministère de l’Intérieur a ainsi dévoilé le « Réseau Radio du Futur » destiné à remplacer des équipements datant des années 1990, rapportent nos confrères de BFM TV.

Ce système fournira des équipements 4G et 5G aux sapeurs-pompiers ou encore aux policiers afin de leur permettre de communiquer instantanément entre le terrain et les salles de commandement.",
"reseau1.jpg", "reseau2.jpg");

insert into blogpost(titre, date, auteur, chapo, contenu, imgheader, imgsecondary) values("Zedu-1, la voiture vraiment zéro émissions", DATE(NOW()), "Stéphane Lémeret", "AUTO - Imaginée par DLR, l’agence aérospatiale allemande, la Zedu-1 est la future voiture zéro émission ! ", "Une électrique plus propre que jamais, c’est le projet de la DLR avec la Zedu-1 (Zero Emission Drive Unit). Cette voiture vise en effet à récupérer ses propres polluants, puisqu’un dispositif installé autour des roues a pour mission de récolter les particules des pneus et des freins. Un véhicule réellement neutre en émissions, donc. Le ministère allemand de l’Économie a d’ailleurs investi six millions d’euros dans le projet. ",
"voiture1.jpg", "voiture2.jpg");

insert into blogpost(titre, date, auteur, chapo, contenu, imgheader, imgsecondary) values("Le boisement extensif augmente les précipitations sur le plateau de Lœss", DATE(NOW()), "Xinhua News Agency", "NATURE - Garnir d'arbres un espace peut-il jouer sur le climat régional ? Et, dans ce cas, quel est le rôle des précipitations ? Une équipe de chercheurs chinois révèle ses observations sur le sujet. ", "Des chercheurs chinois ont récemment révélé que le boisement à grande échelle a contribué à augmenter les précipitations sur le plateau de Lœss, dans le nord-ouest du pays, en intensifiant le cycle de l'eau atmosphérique. 
Selon les chercheurs de l'université de Lanzhou, cette dernière étude permet de mieux comprendre comment le boisement affecte le climat régional du point de vue du recyclage des précipitations, et soutient les stratégies de boisement durable.
